...
provisioner "file" {
  ...
  provisioner "shell" {
    ...
    inline          = ["mkdir -p /home/vagrant/.ssh", "mkdir -p /root/.ssh", "chmod 600 /home/vagrant/id_rsa_itmo-453-deploy", "cp -v /home/vagrant/id_rsa_itmo-453-deploy /home/vagrant/.ssh/", "cp -v /home/vagrant/config /home/vagrant/.ssh/", "cp -v /home/vagrant/config /root/.ssh/"]
  }
