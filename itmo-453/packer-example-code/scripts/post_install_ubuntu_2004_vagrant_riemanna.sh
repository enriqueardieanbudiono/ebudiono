...
cp -v ebudiono/itmo-453/week-11/riemann/riemanna/riemann.config /etc/riemann/riemann.config
...
cp -v ebudiono/itmo-453/week-11/etc/riemanna/* /etc/riemann/examplecom/etc/
...
cp -v ebudiono/itmo-453/week-12/collectd/riemann/riemanna/collectd.conf.d/* /etc/collectd/collectd.conf.d/
