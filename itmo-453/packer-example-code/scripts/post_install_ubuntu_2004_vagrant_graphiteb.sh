...
sudo cp -v ./ebudiono/itmo-453/week-09/graphite/graphiteb/carbon.conf /etc/carbon/carbon.conf

## Code to cp our storage aggregation configuration files and overwrite the default
sudo cp -v ./ebudiono/itmo-453/week-09/graphite/graphiteb/storage-schemas.conf /etc/carbon/storage-schemas.conf
...
sudo cp -v ./ebudiono/itmo-453/week-09/graphite/graphiteb/graphite-carbon.default /etc/default/graphite-carbon
...
sudo cp -v ./ebudiono/itmo-453/week-09/graphite/graphiteb/graphite-api.yaml /etc/
