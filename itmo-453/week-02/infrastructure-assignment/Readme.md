...
![Virtualbox output](media/virtualbox.png)
...
![vagrant version](media/vagrant.png)
...
![vagrant box list](media/vagrant-box-list.png)
...
![packer version](media/packer.png)
...
![packer build .](media/packer-build-..png)
