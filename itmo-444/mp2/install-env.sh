...
sudo -u ubuntu npm install aws-sdk @aws-sdk/client-s3@3.202.0 @aws-sdk/client-sns @aws-sdk/client-rds express multer multer-s3 mysql2
...
####################################################################
sudo -u ubuntu git clone git@github.com:illinoistech-itm/ebudiono.git

# Start the nodejs app where it is located via PM2
# https://pm2.keymetrics.io/docs/usage/quick-start
cd /home/ubuntu/ebudiono/itmo-444/mp2/

sudo pm2 start app.js --watch

# Delete the RSA private key once setup is finished
sudo rm /home/ubuntu/.ssh/id_ed25519